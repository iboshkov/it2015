...
public partial class Zadaca : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (tbCC.Text == validenCC)
        {
            ...
            if (kolac == null) kolac = new HttpCookie("klient");
            kolac["ime"] = tbIme.Text;
            kolac["prezime"] = tbPrezime.Text;
            kolac["poseta"] = DateTime.Now.ToString();
            kolac.Expires = DateTime.Now.AddMonths(6);
